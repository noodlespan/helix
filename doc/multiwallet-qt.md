...
In order to support loading of multiple wallets in tcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tcash.cpp.
...
Changes to tcash.cpp
----------------------
tcash.cpp is the entry point into tcash-qt, and as such, will require some minor modifications to provide hooks for
