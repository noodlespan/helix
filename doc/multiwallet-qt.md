...
In order to support loading of multiple wallets in helix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is helix.cpp.
...
Changes to helix.cpp
----------------------
helix.cpp is the entry point into helix-qt, and as such, will require some minor modifications to provide hooks for
