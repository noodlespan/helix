...
The Helix Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Helix Core project, and is not to be
confused with overall Helix Network Protocol consensus changes.

Whether a pull request is merged into Helix Core rests with the project merge
...
Patches that change Helix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Helix consensus, it must have been
...
The project leader is the release manager for each Helix Core release.
