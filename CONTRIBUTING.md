...
The following applies to code changes to the Tcash Core project, and is not to be
confused with overall Tcash Network Protocol consensus changes.
...
Patches that change Tcash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tcash consensus, it must have been
