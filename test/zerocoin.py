...
#   c) node1 mines 32 blocks, so now node 0 has 60001tcash, node 1 has 4250tcash, node2 has none.
#   d) node0 sends 601 tcash to node2, in two transactions (301 tcash, then 300 tcash).
