...
#   c) node1 mines 32 blocks, so now node 0 has 60001t_cash, node 1 has 4250t_cash, node2 has none.
#   d) node0 sends 601 t_cash to node2, in two transactions (301 t_cash, then 300 t_cash).
