...
/** Utility functions used by the Tcash Qt UI.
 */
namespace GUIUtil
{
...
// Render Tcash addresses in monospace font
...
// Parse "tcash:" URI into recipient object, return true on successful parsing
