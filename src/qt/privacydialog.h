...
public:
    ...
    void setZT_cashControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTCASH_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTCASH_clicked();
    void on_pushButtonZT_cashControl_clicked();
