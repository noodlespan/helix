...
public:
    ...
    void setZHlixControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzHLIX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzHLIX_clicked();
    void on_pushButtonZHlixControl_clicked();
