 ...
 */
    ...
    typeWidget->addItem(tr("Received Tcash from zTcash"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTcash"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTcash));
