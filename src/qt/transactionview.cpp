 ...
 */
    ...
    typeWidget->addItem(tr("Received T_cash from zT_cash"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zT_cash"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zT_cash));
