                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tcash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tcash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tcash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTCASH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tcash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tcash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tcash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tcash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tcash addresses"));
    ...
    openAction->setStatusTip(tr("Open a Tcash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tcash Core help message to get a list with possible Tcash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tcash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tcash network", "", count));
}
...
{
    QString strTitle = tr("Tcash Core"); // default title
