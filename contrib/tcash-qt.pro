...
RESOURCES += 	\
		../src/qt/tcash.qrc \
		../src/qt/tcash_locale.qrc

TRANSLATIONS += src/qt/locale/tcash_bg.ts \
                src/qt/locale/tcash_de.ts \
                src/qt/locale/tcash_en.ts \
                src/qt/locale/tcash_es.ts \
                src/qt/locale/tcash_fi.ts \
                src/qt/locale/tcash_fr.ts \
                src/qt/locale/tcash_it.ts \
                src/qt/locale/tcash_ja.ts \
                src/qt/locale/tcash_pl.ts \
                src/qt/locale/tcash_pt.ts \
                src/qt/locale/tcash_ru.ts \
                src/qt/locale/tcash_sk.ts \
                src/qt/locale/tcash_sv.ts \
                src/qt/locale/tcash_vi.ts \
                src/qt/locale/tcash_zh_CN.ts \
                src/qt/locale/tcash_zh_TW.ts
